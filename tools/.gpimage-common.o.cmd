cmd_tools/gpimage-common.o := cc -Wp,-MD,tools/.gpimage-common.o.d -Wall -Wstrict-prototypes -O2 -fomit-frame-pointer    -include ./include/libfdt_env.h -idirafterinclude -idirafter./arch/arm/include -I./lib/libfdt -I./tools -DUSE_HOSTCC -D__KERNEL_STRICT_NAMES -D_GNU_SOURCE  -c -o tools/gpimage-common.o tools/gpimage-common.c
...
deps_tools/gpimage-common.o := \
  ...
  tools/../include/../lib/libfdt/libfdt.h \
  include/libfdt_env.h \
  lib/libfdt/fdt.h \
